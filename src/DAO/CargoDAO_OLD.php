...
class CargoDAO_OLD {
    ...
    public static function deleteCargo($cve,$p){   
        ...
        try{
            ...
            SELECT cve_cargo,cve_accion,cve_cuota,cve_persona,concepto,total,subtotal,iva,cantidad,periodo,responsable_carga,? AS res_cancelar,fecha_cargo,recargo,? AS motivo  
